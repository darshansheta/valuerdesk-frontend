<template>
  <div tabindex="-1" role="dialog" class="modal" :class="{fade:transitionDuration>0}" @click.self="backdropClicked">
    <div ref="dialog" class="modal-dialog" :class="modalSizeClass" role="document" :style="dialogStyle">
    <!-- below two tags are for resizer if there is issue please remove below two -->
    <!-- <split-pane :min-percent='5' :default-percent='30' split="vertical">
    <template slot="paneR"> -->
      <div class="modal-content">
        <div class="modal-header" v-if="header">
          <slot name="header">
            ...
            <h4 class="modal-title semi-bold">
        ...
        <div class="modal-footer" v-if="footer" :style="dialogFooterStyle">
          <slot name="footer">
